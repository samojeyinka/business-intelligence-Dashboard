        ...
        <main className="pt-24 pb-20 px-4 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-zinc-400 mb-4">
              Thank you for your contribution to Our Open Blog. Your article has been verified and received. It will be reviewed by our team before being published.
            </p>
            ...
            <p className="text-zinc-400 mb-8">
              We've used your verified email address to confirm your submission. You'll receive notifications about your article's status at this email address.
            </p>
