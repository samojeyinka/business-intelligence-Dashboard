...
<div className={`w-[80%] h-[70%] flex  mx-auto rounded-xl ${darkMode ? "bg-gray-800" : "bg-white"}`}>
      {/* Left Section - Login Form */}
      <div className="w-full  flex gap-5 items-center justify-center p-8">
        <div className={`w-full md:w-1/2  max-w-md p-8 space-y-6 ${
...
// Interactive SVG Illustration Component
function InteractiveIllustration({ darkMode }) {
  useEffect(() => {
    // Animation for the file conversion effect
