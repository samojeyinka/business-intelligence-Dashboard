...
const FeaturesSection: React.FC = () => {
  ...
  const sectorDescriptions: Record<string, string> = {
    ...
    "Exploration & Discovery": "Ventures in this sector are pushing boundaries in science, space, and deep tech to unlock new frontiers of human potential.",
    "Trade & Commerce": "Ventures in this sector are built to transform how goods and services move across communities.",
    "Mobility & Logistics": "Ventures in this sector are revolutionizing how people and products move through space, creating more efficient and sustainable transportation systems.",
